    ...
    <div v-else>
      ...
      <div v-if="groups && groups.length" class="flex font-khmer_os">
        ...
        <div class="h-screen relative w-2/3">
          ...
          <div
              class="border border-gray-200 h-48 overflow-y-scroll w-48 rounded-lg absolute bottom-32 left-4 bg-white mb-2"
              v-if="showMention">
            <ul>
          ...
          <div
              class="flex items-center justify-start bottom-0 px-2 pb-3 w-full absolute bottom-17 left-0 px-4 bg-white">
            <form>
            ...
            <textarea
                ...
                ref="message"
                name="message" @keydown="enableWatch" @keyup.enter.exact="insertChat"/>
          </div>
        </div>
      </div>
    </div>
    <ImgFull v-if="showImgFull"
             :Url="img"
