    ...
    <div class="px-3 my-3 mt-5">
      <div class="grid grid-cols-4 gap-x-11 gap-y-4">
        ...
        <div class="text-center flex flex-col justify-center items-center" @click="goTo('download')">
          <div class="flex-col rounded flex justify-center items-center cursor-pointer h-13 w-13 rounded-full"
               :class="activeClass(`download`) + ' ' + activeClass(`download-detail`)">
            <div>
              <DownloadIcon :size="24" fill="#FFFFFF"
                            v-if="$route.name === `download` || $route.name === `download-detail`"></DownloadIcon>
          ...
          <div class="flex-col rounded flex justify-center items-center cursor-pointer h-13 w-13 rounded-full"
            ...
            <div>
              <DocumentIcon :size="24" fill="#FFFFFF"
                            v-if="$route.name === `document` || $route.name === `document-detail`"></DocumentIcon>
