      ...
      <div class="grid grid-cols-4 gap-x-11 gap-y-4">
        ...
        <div class="text-center flex flex-col justify-center items-center" @click="shareApp">
          <div class="flex-col rounded flex justify-center items-center cursor-pointer h-13 w-13 rounded-full"
               :class="activeClass('')">
            <div>
              <ShareIcon :fill="darkMode?`#FFFFFF`:`#4A4A4A`"></ShareIcon>
            </div>
        ...
        <div class="text-center flex flex-col justify-center items-center" @click="setDarkMode(darkMode)">
          <div class="flex-col rounded flex justify-center items-center  cursor-pointer h-13 w-13 rounded-full"
               :class="activeClass('')">
            <div>
              <ModeIcon :fill="darkMode?`#FFFFFF`:`#4A4A4A`"></ModeIcon>
            </div>
        ...
        <div class="text-center flex flex-col justify-center items-center">
          <div class="flex-col rounded flex justify-center items-center  cursor-pointer h-13 w-13 rounded-full"
            ...
            <div v-if="localize==='en'">
              <KhIcon :fill="darkMode?`#FFFFFF`:`#4A4A4A`"></KhIcon>
            </div>
            <div v-else>
              <EnIcon :fill="darkMode?`#FFFFFF`:`#4A4A4A`"></EnIcon>
            </div>
    ...
    <div class="fixed w-full h-full left-0 top-0 flex items-center justify-center bg-black bg-opacity-95" v-if="share">
      <div class="w-80 rounded-xl" :class="darkMode?`bg-secondary text-gray-300`:`bg-white`">
        ...
        <div class="flex px-5 mb-5 items-center relative">
          <input type="text" class="w-full h-10 border focus:outline-none rounded-md pl-2 " v-model="link" id="link"
