<template>
  <div>
      ...
      <div class="w-3/5">
        <div :class="darkMode?`bg-youtube text-gray-300`:`bg-white pb-5 shadow rounded-b-lg text-sm`">
          <div class="relative" @mouseover="() => {this.fullScreenBtn = true}"
            ...
            <video controlsList="nodownload" autoplay class="m-auto w-full outline-none" id="vid" ref="eVideo"
            ...
            <div class="absolute w-full bottom-0 flex justify-end items-end px-10">
              <div
                ...
                <div v-if="showPlay" @click="playPause">
                  <PlayIcon fill="#ffffff"></PlayIcon>
                </div>
                <div v-else @click="playPause">
                  <PauseIcon fill="#ffffff"></PauseIcon>
                </div>
                <!-- Duration -->
                ...
                <div class="flex-1 relative">
                  ...
                  <div class="bg-white absolute" style="height:4px;bottom:6px;z-index:1"
                ...
                <div class="relative">
                  ...
                  <div
                      ...
                      @mouseleave="() =>{this.showSound = false}" @mouseover="() =>{this.showSound = true}">
                    <input type="range" min="0" max="100" step="1" v-model="defaultVolumeRange" id="volumeSlider"
                           class="w-full cursor-pointer slider relative left-2" @change="setVolume"
    ...
    <Cart v-if="showCart" @closeCart="()=>{this.showCart = false}"
          @showInvoice="(data) =>{ this.showCart = false; this.showReceipt = true;this.receiptDetail = data}"></Cart>
