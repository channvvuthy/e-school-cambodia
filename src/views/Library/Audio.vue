<template>
    <div>
        ...
        <!-- List -->
        <div class="fixed w-full h-full right-0 bottom-0 z-50 flex flex-col px-10 items-center bg-black bg-opacity-90 justify-center" v-if="showAudioList">
                ...
                <div class="max-h-96 overflow-y-scroll">
                    <div class="flex items-center justify-between py-4 px-5 cursor-pointer border-t" :class="darkMode?`border-button`:``" v-for="(ad, index) in details.list" :key="index" @click="selectingAudio(ad,index)">
                        <div class="flex items-center">
                            <div class="h-10 w-10 rounded-full flex justify-center items-center" :class="darkMode?`bg-pass`:`bg-primary`">
