...
export default {
  ...
  methods: {
    ...
    closeBackground() {
      if (this.payload.caption && this.selectedFiles.length) {
        this.type = "share_photo_and_status";
      } else if (this.payload.caption && this.videoPreview) {
        this.type = "share_video_and_status";
      } else {
        this.type = "share_status";
      }
  ...
  watch: {
    "payload.caption": function (caption) {
      if (caption.length) {
        if (this.selectedFiles.length || this.singlePhotoPreview) {
          this.type = "share_photo_and_status";
        } else if (this.videoPreview) {
          this.type = "share_video_and_status";
        } else {
