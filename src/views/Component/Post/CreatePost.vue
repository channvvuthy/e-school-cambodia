        ...
        >
                    ...
                    <div>
                        ...
                        <div>
                            <div
                                ...
                                <div>
                                    <ChevronDown :fill="darkMode ? `#909090` : `#000000`" :size="15"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="preview pb-5"
                    ...
                    <div class="px-5" v-else>
                        <textarea
                                ...
                                :placeholder="$t('say_something')"
                                @input="resize($event)"
                                @focus="resize($event)" class="w-full outline-none bg-transparent"
                                style="resize: none"/>
                        <div class="relative flex items-center justify-center">
                            ...
                            <template v-if="videoPreview">
                                <div class="relative w-full" @mouseenter="()=>{this.isVideo = true}"
                                    ...
                                    <div class="w-full h-full flex items-center justify-center absolute z-40 top-0 left-0"
                                         v-if="isVideo">
                                        <div
                                                class="h-14 text-white w-14 rounded-full flex items-center justify-center
                                                 bg-black bg-opacity-50 border-white border-4 shadow cursor-pointer">
            ...
            >
                ...
                <template v-else>
                    ...
                    >
                        <CameraIcon :width="20" :height="22" :fill="darkMode ? `#909090` : `#055174`"/>
                    </div>
                    <div
                            class="w-10 h-10 rounded-full flex items-center justify-center cursor-pointer"
                            :class="darkMode ? `bg-button`: `bg-softGray`"
                    ...
                    >
                        ...
                        <input type="file" class="hidden" multiple accept="image/*" ref="multiple-photo"
                               @change="selectFiles">
                    </div>
                    <div
                            class="w-10 h-10 rounded-full flex items-center justify-center cursor-pointer"
