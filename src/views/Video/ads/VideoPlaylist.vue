        ...
        <div>
            <div class="relative" @mouseleave="()=>{this.showToolbar = false}">
                <div class="w-11/12 relative m-auto">
                    <div class="flex justify-center items-center bg-black bg-opacity-70 rounded py-1 px-2 absolute top-5 cursor-pointer z-50"
                ...
                <div class="absolute bottom-3 w-full px-5">
                    <div class="bg-black text-white rounded-md text-sm bg-opacity-70 h-10 flex justify-between px-5 items-center m-auto"
