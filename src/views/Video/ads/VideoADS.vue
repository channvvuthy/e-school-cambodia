    ...
    <div class="fixed inset-0 overflow-y-auto font-khmer_os" style="z-index:53">
        <div class="flex items-end justify-center min-h-screen text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                <div class="absolute inset-0 bg-black" @click="closeAds"
                ...
                <div class="flex justify-center items-center text-center py-10">
                    <div>
                        <div class="relative">
                            ...
                            <div class="bg-black text-white rounded-md text-sm bg-opacity-70 h-10 flex justify-between px-5 items-center w-11/12 relative -top-14 m-auto"
