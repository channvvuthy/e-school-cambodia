<template>
    <div class="mt-3 overflow-y-scroll h-screen pb-40 relative"
        ...
        <div class="m-5">
            ...
            <div v-else class="grid gap-4" :class="isHide?`grid-cols-4`:`md:grid-cols-3 2xl:grid-cols-5`">
                    ...
                    <div class="relative cursor-pointer view"
                        ...
                        <div class="flex flex-col relative w-full justify-center items-center -top-10 px-5">
                            <div @click="gotToPlayList(video)" class="flex flex-col relative w-full">
                                ...
                                <div class="text-sm font-semibold mt-3 text-center">{{ cutString(video.title, 30) }}
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions('zoom', ['getZoomPackage']),
            enableUserScroll() {
