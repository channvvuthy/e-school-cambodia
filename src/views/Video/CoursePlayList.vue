  ...
  <div>
    ...
    <div class="flex mt-5 ml-5 relative">
      ...
      <div class="w-3/5">
        ...
        <div class="shadow pb-2 flex-1" :class="darkMode?`bg-youtube text-gray-300`:`bg-white `"
             v-else>
          <VideoPlaylist @endedVideo="endedVideo" @lastWatchVideo="lastWatchVideo($event)"
                         :_id="video._id"></VideoPlaylist>
          <div class="mx-5 mt-6">
            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <div class="flex items-center">
                  <div class="cursor-pointer"
                    ...
                    <FavoriteFill v-if="video.is_favorite" :size="24"
                                  :fill="darkMode?`#E5E7EB`:`#c0272d`"></FavoriteFill>
              ...
              <div class="flex items-center cursor-pointer"
                   v-if="($route.params.course.has_certificate && $route.params.course.is_buy)"
      ...
      <div class="flex-1">
        ...
        <ForumComment v-if="!showMenu" :comments="comments" :loading="loadingComment" @openModal="openModal($event)"
                      @reply="reply" @replyTextComment="replyTextComment($event)"
                      @loadMoreComment="loadMoreComment($event)"></ForumComment>
