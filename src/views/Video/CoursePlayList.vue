<template>
    <div>
        ...
        <Cart v-if="showCart"
              @closeCart="closeCart"
              @showInvoice="(data) =>{
                  this.showCart = false; this.showReceipt = true;this.receiptDetail = data
              }"/>
        <!-- Receipt info -->
        <ReceiptInfo
                v-if="showReceipt"
            ...
            <div class="flex-1">
                ...
                <div v-if="!showMenu"
                    ...
                    <div class="shadow rounded-md flex justify-center items-center h-8 px-2 mr-4 cursor-pointer"
                         @click="backMenu">
                        <BackIcon :width="20" :height="20" :fill="darkMode?`#afb0b4`:`#000000`"/>
                    </div>
                ...
                <Quiz
                        v-if="active === 'quiz'"
                        @startingExam="startingExam($event)"/>
            </div>
        </div>
