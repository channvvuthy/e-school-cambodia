<template>
  <div :class="parentClass" id="parent" @click="closeSticker">
    <div
        :class="`${defaultPosition} + ${darkMode ? `bg-secondary border-button` : `bg-white`}`">
...
export default {
  ...
  props: {
    ...
    defaultPosition: {
      default: () => 'border fixed right-5 bottom-20 w-96 h-1/2 z-50 rounded-xl shadow-lg flex flex-col justify-between'
    }
  },
  data() {
    return {
