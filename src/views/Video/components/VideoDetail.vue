            ...
            <div class="flex justify-between" style="height: 40rem;">
                <div class="w-3/5 p-5 relative">
                    <div v-if="loadingNext">
                        <div
                                class="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 background-animate w-full"
                    ...
                    <MediaPlayer
                            ...
                            :is-auto-play="true"
                            :isFullScreen="false"
                            :video-url="feed.video.url" :post="feed"/>
                </div>
                                ...
                                <div class="text-lg font-light mb-4"
                                    ...
                                    <div v-if="feed.caption.length > 100">
                                        <span class="less" @click="seeMore">
                                            ...
                                            <span class="capitalize cursor-pointer" :class="darkMode ? `text-gray-300`: `text-primary`">
                                                {{ $t('see_more') }}
                                            </span>
                                        </span>
