            ...
            <div class="flex justify-between" style="height: 40rem;">
                <div class="w-3/5 p-5 relative">
                    <div
                            ...
                            v-if="isStyle">
                        <div
                                @click="()=>{this.original = true;this.isStyle = false;}"
                            ...
                            <div>
                                <ImageIcon :fill="original === true ? '#FFF': '#8e8e8e'" :width="23"/>
                            </div>
                        </div>
                        <div
                                @click="()=>{this.original = false;this.isStyle = false;}"
                                class="flex items-center justify-between cursor-pointer p-3"
                                :class="original ? `text-instagram`: `text-white`">
                            <div>
                                1 : 1
                            </div>
                            <div class="border rounded w-6 h-6"
                                 :class="original ? `border-instagram`: `border-white`"></div>
                        </div>
                    </div>
                    <div
                ...
                <div class="w-2/5 pt-5">
                    <div class="border h-full border-b-0 border-r-0 flex flex-col justify-between"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <div class="cursor-pointer">
                                            ...
                                            <div @click="likePost(post)" v-else>
                                                <LikeIcon :size="22" :fill="darkMode ? `#909090`: `#4A4A4A`"/>
                                            </div>
                                                ...
                                                <div v-if="replies.comment && replies.comment._id === comment._id">
                                                    <div v-for="(list, index) in replies.list">
                                                        <Comment
                                                                ...
                                                                :comment="list" @reply="reply($event)"/>
                                                    </div>
                                                </div>
                                                <div v-else>
                                                    <Comment
                        ...
                        <div
                            ...
                            <div style="background-color: rgba(5,81,116,0.2)"
                                 class="rounded-full h-9 w-9 cursor-pointer">
                                <input type="file" ref="popupComment" @change="selectPhoto" accept="image/*"
                                       class="hidden">
