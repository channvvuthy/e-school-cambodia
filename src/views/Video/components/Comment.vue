    ...
    <div @mouseleave="clearAction">
        <div class="mt-4 flex space-x-5" :id="comment._id">
            ...
            <div
                ...
                <div v-if="comment.content.photo" class="cursor-pointer">
                    <div @click="viewImage(comment.content.photo.url)">
                        <img :src="comment.content.photo.url" class="max-h-40 rounded my-2 m-auto">
                    </div>
                </div>
                <div v-if="comment.content.sticker" class="cursor-pointer">
                    <div @click="viewImage(comment.content.sticker.url)">
        ...
        <template v-if="isEdit">
            <EditComment
                    ...
                    @closeComment="()=>{this.isEdit = false}"/>
        </template>
        <PreviewImage v-if="isPreview" :URL="imgUrl" @closePreviewImage="()=>{this.isPreview = false}"/>
    </div>
</template>
...
<script>
    ...
    import PreviewImage from "../../Chat/components/PreviewImage";
