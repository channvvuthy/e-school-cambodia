        ...
        <div class="flex justify-center">
            <div>
                ...
                <div :class="darkMode?`bg-secondary`:`shadow-xl border-t border-gray-100`" class="rounded-xl py-10 px-5 mt-10 w-72 text-center">
                    ...
                    <div class="mt-5 font-semibold" :style="darkMode?``:{color:`#c0272d`}">{{result.correct}}/{{result.total_quiz}}</div>
                ...
                <div class="w-72 flex justify-center items-center">
                    <button class="rounded-md mt-10 w-full focus:outline-none py-2 px-5 shadow-lg" :class="darkMode?`bg-button text-gray-300`:`bg-primary text-white `" @click="exit">{{$t('2132')}}</button>
                </div>
            </div>
        </div>
    </div>
