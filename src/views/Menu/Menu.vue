    ...
    <div class="pl-12 pr-5 flex justify-between items-center">
      ...
      <div class="flex justify-end" v-if="token">
        <div class="flex justify-between items-end flex-1">
          <div class="flex flex-col justify-center items-center cursor-pointer relative "
               @click="() =>{this.$emit('showItemIncart')}" id="myCart">
          ...
          <div class="flex flex-col justify-center items-center cursor-pointer ml-10 relative"
            ...
            <template>
              <div
                  class="absolute -top-3 left-4 h-5 w-5 rounded-full flex justify-center items-center text-center text-xs"
                  :class="darkMode?`bg-white text-youtube`:`bg-heart text-white`" v-if="notify.notifications">
                <div style="margin-top:2px">
