<template>
    <div>
        <template v-if="message.content.type">
            <div v-if="isAdmin"
                 :class="isAdmin?`${darkMode?`chat-bubble-right-dark`:`chat-bubble--right`}`:`${darkMode?`bubble bubble--left-dark`:`bubble--left`}`"
                 class="relative chat-bubble">
                <span v-if="message.content.type == 0"
                      :class="darkMode?`text-fb`:`text-primary`" class="cursor-pointer"
            ...
            <div v-else
                 :class="isMind?`${darkMode?`chat-bubble-right-dark`:`chat-bubble--right`}`:`${darkMode?`bubble bubble--left-dark`:`bubble--left`}`"
                 class="relative chat-bubble">
                <span v-if="message.content.type == 0" :class="darkMode?`text-fb`:`text-primary`"
