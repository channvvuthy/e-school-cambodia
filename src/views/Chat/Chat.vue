            ...
            <div class="flex-1 w-full ml-2 h-screen flex flex-col bg-cover" :class="darkMode?`bg-dark`:`bg-light-mode`">
                ...
                <div class="flex-1 h-full flex flex-col pb-36 py-5">
                    ...
                    <div class="h-24 flex items-center px-5 relative z-40"
                         :class="darkMode?`bg-secondary text-gray-300`:`bg-white e-shadow text-primary`"
                         v-if="replyContact">
                    ...
                    <div class="h-24 flex items-center px-5 relative z-40"
                        ...
                        <textarea class="w-full h-14 border-2 text-black rounded-full focus:outline-none mx-5 py-4 px-5"
                                  ...
                                  :placeholder="$t(`2112`)"
                                  :class="darkMode?`bg-youtube border-transparent text-gray-300`:``">
                        </textarea>
                    ...
                    <div class="w-full h-full fixed top-0 left-0 bg-black z-50 flex items-center justify-center bg-opacity-90"
                        ...
                        <div class="w-96 rounded-lg flex flex-col justify-between"
                            ...
                            <div class="flex justify-start px-3 w-full relative items-center">
                                ...
                                <div class="flex items-center absolute -top-3 justify-center w-full text-center"
                                     v-if="sending">
                                    <div class="loader"></div>
                                </div>
                                <button
