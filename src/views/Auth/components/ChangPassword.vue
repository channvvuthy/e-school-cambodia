    ...
    <div>
      <div class="fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-end justify-center min-h-screen text-center sm:block sm:p-0">
          ...
          <div
              class="inline-block align-bottom bg-white rounded overflow-hidden shadow-xl transform transition-all  sm:align-middle"
            ...
            <div class="bg-white p-5 relative">
              ...
              <div class="flex-cols justify-center items-center font-khmer_os text-sm">
                ...
                <div class="flex justify-end">
                  <button
                      class="bg-blue-700 rounded px-5 py-3 text-white mt-5 font-khmer_os hover:bg-blue-800 focus:outline-none"
                      :disabled="changing"
