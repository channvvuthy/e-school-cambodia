<template>
  <div class="w-full h-28 flex items-end pb-3 shadow"
    ...
    <div class="flex px-10 items-center">
      <div class="shadow-md flex justify-center items-center h-8 px-2 cursor-pointer rounded-full w-8"
    ...
    <div class="flex-1 w-full flex justify-end px-5 items-center cursor-pointer"
         @click="() => {this.$router.push({name:'network'})}">
      <AddUserIcon :fill="darkMode?`#909090`:`#055174`"/>
    </div>
  </div>
</template>
<script>
