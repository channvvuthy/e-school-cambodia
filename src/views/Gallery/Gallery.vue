<template>
  <div>
    <!-- Popup -->
    <div
        class="fixed w-full h-full top-0 left-0 z-50 bg-black bg-opacity-95 p-5 overflow-y-scroll flex items-center justify-center"
        v-if="previewStory">
    ...
    <div v-else class="m-5">
      <div class="h-screen pb-40 overflow-y-scroll" @scroll="getMoreGallery($event)">
        ...
        <div :class="window.width <= 1315?`container-4`:`container-5`">
          <div v-for="(gallery, index) in galleries" :key="index" class="cursor-pointer"
