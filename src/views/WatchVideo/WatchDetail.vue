        ...
        <div class="overflow-y-scroll pb-40 h-screen">
            <div class="px-5 mt-5">
                ...
                <div class="flex justify-between" v-else>
                        ...
                        <div class="progressVideoDetail flex items-center justify-center">
                            <div>
                                ...
                                <div class="barOverflowVideoDetail">
                                    <div class="barVideoDetail" :style="{transform:`rotate(${45+(Math.round($route.params.percentage)*1.8)}deg)`}"></div>
                                </div>
                    ...
                    <div class="w-5"></div>
                    <div :class="darkMode?`bg-secondary text-gray-300`:`bg-white`" class="rounded-xl shadow-md p-5 w-full flex flex-col overflow-y-scroll pb-40 h-full">
                        <div v-for="(list, index) in courseDetail.list" :key="index" :class="darkMode?`bg-button mb-5`:`bg-dadada mb-5`" class="rounded-xl p-5">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="h-4 w-full rounded-full mr-5 my-4" :class="darkMode?`bg-byline`:`bg-gray-400`">
                                    <div :class="darkMode?`bg-pass`:`bg-primary`" class="rounded-full h-4" :style="{width:`${list.percentage}%`}"></div>
                                </div>
                                <div>100%</div>
                            </div>
                        </div>
