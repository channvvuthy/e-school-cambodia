              ...
              <div v-else>
                ...
                <div class="flex justify-center items-center h-85"
                  ...
                  <div class="focus:outline-none">
                    ...
                    <button
                        class="flex justify-center text-center hover:opacity-80 focus:outline-none m-auto items-center bg-custom px-3 py-2 mt-3 text-white rounded-full"
                ...
                <li class="flex cursor-pointer text-13px border border-gray-200 border-t-0 border-l-0 border-r-0 py-3 px-3"
                  ...
                  <div class="mr-3">
                    <template v-if="books.is_buy === 1">
                      <CheckIcon
                          fill="#009e03" :width="20"
                          :height="20"/>
                    </template>
                    <template v-else>
                      <CloseIcon
                          fill="#ee3d3c" :width="20" :height="20"
