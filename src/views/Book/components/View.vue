<template>
  <div class="fixed z-50 inset-0 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen text-center sm:block sm:p-0">
      ...
      <div
          class="inline-block align-bottom bg-white rounded text-left overflow-hidden shadow-xl transform transition-all  sm:align-middle"
        ...
        <div class="bg-white font-khmer_os relative">
            ...
            <div class="relative pb-10" style="max-height: 600px;overflow-y: scroll">
              <div class="bg-black py-5 relative">
                ...
                <template v-if="!alreadyInCart(view._id ) && !view.is_in_cart">
                  <div
                      class="absolute bottom-5 right-5 bg-white rounded py-1 px-2 cursor-pointer opacity-80 hover:opacity-100"
          ...
          <button
              class="fixed bottom-0 bg-blue w-full p-3 bg-custom text-center text-white cursor-pointer focus:outline-none"
