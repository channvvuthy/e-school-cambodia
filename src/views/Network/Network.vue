<template>
    <div>
        ...
        <div class="p-5 h-screen pb-40">
            <div class="w-4/6 rounded-xl p-5 overflow-y-scroll" :class="darkMode?`bg-secondary`:`bg-white shadow`" style="height:93%" @scroll="onScroll">
                
                <div class="relative w-3/4 sticky top-0">
                    <input type="text" class="focus:outline-none h-10 rounded-md bg-softGray pl-3 text-sm w-full" :placeholder="$t('1001')" :class="darkMode?`bg-button text-gray-300`:``" v-on:keyup.enter="search" v-model="s">
