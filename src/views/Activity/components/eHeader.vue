<template>
    <div class="w-full h-28 flex items-end pb-3 shadow"
        ...
        <div class="flex px-10 items-center">
            <div class="shadow-md rounded-full w-8 flex justify-center items-center h-8 px-2 mr-6 cursor-pointer"
                 :class="isHide?`ml-7`:`ml-3`"
                 @click="back()">
                <BackIcon :width="20" :height="20" :fill="darkMode?`#D1D5DB`:`#000000`"/>
            </div>
            <div class="w-9 h-9 rounded-full mr-5 bg-cover bg-center"
