    ...
    <div class="text-sm" :class="darkMode?`text-gray-400`:``">
        ...
        <div class="mt-5 px-5 h-screen pb-40 overflow-y-scroll" @scroll="onScroll">
            ...
            <div v-else>
                ...
                <div v-for="(summary, index) in summariesDetail"
                     :key="index" class="mb-5 max-w-screen-lg rounded-lg shadow-md"
                     :class="darkMode?`bg-secondary`:`bg-white`">
                    <div class="rounded-t-lg h-14 flex items-center justify-start pl-5 text-base"
                         :class="darkMode?`bg-primary text-white`:`bg-dadada`">
                    ...
                    <div class="px-5 py-9">
                        <div class="flex items-center">
                            ...
                            <template v-if="$route.params.type == 1">
                                <div class="rounded-full h-14 w-14 flex items-center justify-center"
                                     style="background-color:#f7b616">
                                    <svg height="34" viewBox="-21 -117 682.66672 682"
                        ...
                        <div v-for="(list, key) in summary.list" :key="key"
                             class="flex justify-start items-center py-5">
                            <div class="w-32" :class="darkMode?``:`text-primary`">
                                <div class="flex items-center">
                                    <div class="mr-2">
                                        <ClockIcon :size="20" :fill="darkMode?`#909090`:`#055174`"/>
                                    </div>
