<template>
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="24" viewBox="0 0 330 330" style="enable-background:new 0 0 330 330" xml:space="preserve">
        <g :fill="fill">
            <g>
            <g>
