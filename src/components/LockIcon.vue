<template>
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" :height="size" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 471.7 471.7" style="enable-background:new 0 0 471.7 471.7" xml:space="preserve">
        <g :fill="fill">
            <g>
