<template>
    <div class="fixed inset-0 overflow-y-auto bg-black bg-opacity-90 flex items-center justify-center items-center" style="z-index: 52">
        <div class="inline-block align-bottom rounded-xl text-left overflow-hidden shadow-xl max-w-lg min-w-96" :class="darkMode?`bg-secondary text-gray-300`:`bg-white`">
            <div class="header flex justify-between items-center p-4 border-b text-sm font-khmer_os" :class="darkMode?`border-button`:`border-bordergray-200`">
...
import Video from '../views/Library/Video.vue'
    export default{
        name: "Notification",
        data(){
            return {
